...
def execute():
    script = "RadiantEditor Wavefront OBJ Export (*.obj)"
    author = "Python port by greebo, based on original exporter C++ code in GtkRadiant and the ASE exporter scripts"
    version = "0.2"
