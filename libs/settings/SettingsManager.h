 ...
 * to the user's settings path. RadiantEditor 2.15+ or higher stores its settings
 * in folders specific to their major and minor versions:
 *
 * $HOME/.config/radianteditor/2.15/
 * $HOME/.config/radianteditor/3.0/
 *
 ...
 * For backwards compatibility with RadiantEditor versions that have not been
...
public:
    // Construct a settings manager for this version of RadiantEditor
     ...
     * considered too (with the lowest priority), as RadiantEditor versions prior to 2.15
