...
RadiantEditor ships with a number of different user interface layouts, which
...
menu, and will require RadiantEditor to be restarted.
...
RadiantEditor defaults to a black-on-white colour scheme in the 2D windows, but
